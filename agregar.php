  ...
  <table width="100%" height="100%" border="0" style="margin-top:-2px; margin-left:-1px;">
      <tr>
        ...
        <?php echo $GPSUSERNAME; ?>
         ...
         &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        <?php echo 'PROYECTO DE CONAVIA Y PC' ?>
         &nbsp&nbsp&nbsp&nbsp
        ...
        font:Georgia, 'Times New Roman', Times, serif bold; width:400px;">
            <a href="conavia.php" style="text-decoration:none; color:#FFF;"><div class="lnk">Inicio</div></a>
            <a href="archivos_uplo.php" style="text-decoration:none; color:#FFF;"><div class="lnk">Archivos</div></a>
            <a href="listar_proyectos.php" style="text-decoration:none; color:#FFF;"><div class="lnk">Proyectos</div></a>
            <a href="agregar.php" style="text-decoration:none; color:#FFF;"><div class="lnk">Agregar</div></a>
            <a href="cerrar.php" style="text-decoration:none; color:#FFF;"><div class="lnk">Cerrar</div></a>  
        </div>
        </td>
      </tr>
      <tr>
        <td width="80%" height="100% align="left" valign="top"><iframe frameborder="0" name="iframe" src="responsable.php" id="iframe"></iframe></td>
    </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>

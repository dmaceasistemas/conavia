...
if(isset($Add))
{
			...
			if($count==0)
			{
$sql=mysql_query("INSERT INTO proyecto(`nombre_proyec`,`nombre_ente_contra`,`nombre_ente_sol`,`rif_ente_contra`,`rif_ente_sol`,`descripcion`,`fecha_actual`,`estado`,
 `municipio`,`parroquia`,`sector`,`fecha_inicio`,`fecha_estimada_cul`,`fecha_estimada_ina`,`estatus_obra`) VALUES ('$nombre_proyec','$nombre_ente_contra','$nombre_ente_sol','$rif_ente_contra','$rif_ente_sol','$descripcion','$fecha_actual','$estado',
 '$municipio','$parroquia','$sector','$fecha_inicio','$fecha_estimada_cul','$fecha_estimada_ina','$estatus_obra')");
...
<legend align= "left">Ficha Proyecto</legend>
    <table  align="left" width="100%" height="20%" border="0">
      <tr>
       ...
       <td align="left"><label for="nombre"></label>
        ...
        <td><input type="text" size="40" value="" readonly name="theDate_act"><input type="button" value="Cal" onclick="displayCalendar(document.forms[0].theDate_act,'dd-mm-yyyy',this)"></td>

      </tr>
      <tr>
        <td width="200" align="left">Organismo Responsable</td>
        <td align="left"><label for="nombre_contra"></label>
          <input type="text" size="51" name="nombre_contra" id="nombre_contra" value="<?php echo @$_POST[nombre_contra]?>" placeholder="Organismo Responsable"/> 
          </td>
      ...
      <tr>
        ...
        <td align="left"><label for="nombre_sol"></label>
          <input type="text" size="51" name="nombre_sol" id="nombre_sol" value="<?php echo @$_POST[nombre_sol]?>" placeholder="Ente Ejecutor" required="required" /> 
          <font color="#FF0000">*</font></td>
	 ...
	 while($row=mysql_fetch_array($sql2))
      ...
      <tr>
        ...
        <td align="left"><label for="sector"></label>
          <input type="text" size="51" name="sector" id="sector" value="<?php echo @$_POST[sector]?>" placeholder="Sector" required="required" /> 
          <font color="#FF0000">*</font></td>
      ...
      <tr>
        ...
        <td align="left"><label for="consejo_comu"></label>
          <input type="text" size="51" name="consejo_comu" id="consejo_comu" value="<?php echo @$_POST[consejo_comu]?>" placeholder="Consejo Comunal" required="required" /> 
          <font color="#FF0000">*</font></td>
      ...
      <tr>
        ...
        <td align="left"><label for="comuna"></label>
          <input type="text" size="51" name="comuna" id="comuna" value="<?php echo @$_POST[comuna]?>" placeholder="Comuna" required="required" /> 
          <font color="#FF0000">*</font></td>
	...
	<tr>
        ...
        <td><input type="text" size="40" value="" readonly name="theDate"><input type="button" value="Cal" onclick="displayCalendar(document.forms[0].theDate,'dd-mm-yyyy',this)"></td></tr>

	<tr>
        <td>Fecha Estimada Culminacion (DD-MM-YYYY): </td>
        <td><input type="text" size="40" value="" readonly name="theDate_cul"><input type="button" value="Cal" onclick="displayCalendar(document.forms[0].theDate_cul,'dd-mm-yyyy',this)"></td></tr>

	<tr>
        <td>Fecha Estimada Inagurar (DD-MM-YYYY): </td>
        <td><input type="text" size="40" value="" readonly name="theDate_ina"><input type="button" value="Cal" onclick="displayCalendar(document.forms[0].theDate_ina,'dd-mm-yyyy',this)"></td>

<table  align="left" width="42%" height="10%" border="0">  
     ...
     <table  align="left" width="41%" height="80%" border="0">  
     <td><fieldset style="border: 3px solid #5eb058;">
     <legend align= "left">Responsables del Proyecto</legend>
		...
		if(isset($_POST["responsables"]))
               ...
               while($row=mysql_fetch_array($re1))
		{    
		echo '<option value="'.$row['id'].'">'.$row['nombre_resp'].'</option>';
		}
    ...
    <table  align="left" width="41%" border="0">  
 <form name="frmset" method="post" action="proyecto.php">
     <td><fieldset style="border: 3px solid #5eb058;">
     <legend align= "left">Indicadores de Impacto</legend>
                 Población Beneficiada <input type="text" size="30" name="numero_hab" id="numero_hab" value="<?php echo @$_POST[numero_hab]?>" placeholder="N° habitantes" required="required" /> 
          <font color="#FF0000">*</font>
                 <br>
                 Producción (Tm)<input type="text" name="numero_fam" id="numero_fam" value="<?php echo @$_POST[numero_fam]?>" placeholder="Producción">
                 <br>
                 Rubros<input type="text" size="15" name="numero_pro" id="numero_pro" value="<?php echo @$_POST[numero_pro]?>" placeholder="Rubros">
                       <input type="text" size="15" name="numero_pro" id="numero_pro" value="<?php echo @$_POST[numero_pro]?>" placeholder="Rubros">
                       <input type="text" size="15" name="numero_pro" id="numero_pro" value="<?php echo @$_POST[numero_pro]?>" placeholder="Rubros">
 ...
 <table  align="left" width="51%" border="0">  
 <form name="frmset" method="post" action="proyecto.php">
     <td><fieldset style="border: 3px solid #5eb058;">
     <legend align= "left">Información Financiera</legend>
                 Tiempo Estimado de Ejecución (Meses)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" size="30" name="numero_hab" id="numero_hab" value="<?php echo @$_POST[numero_hab]?>" placeholder="Tiempo Ejecución" required="required" /> 
          <font color="#FF0000">*</font>
                 <br/>
<br/>
                 Monto Total Calculado (Bs)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="numero_fam" id="numero_fam" value="<?php echo @$_POST[numero_fam]?>" placeholder="Monto Total">
                 <br/>
   ...
   <table  align="left" width="34%" border="0">  
 <form name="frmset" method="post" action="proyecto.php">
     <td><fieldset style="border: 3px solid #5eb058;">
     <legend align= "left">Impacto de la Obra</legend>
                 N° de Habitantes <input type="text" name="numero_hab" id="numero_hab" value="<?php echo @$_POST[numero_hab]?>" placeholder="N° habitantes" required="required" /> 
          <font color="#FF0000">*</font>
                 <br>
                 N° de Familias<input type="text" name="numero_fam" id="numero_fam" value="<?php echo @$_POST[numero_fam]?>" placeholder="N° Familias">
                 <br>
                 N° de Productores<input type="text" name="numero_pro" id="numero_pro" value="<?php echo @$_POST[numero_pro]?>" placeholder="N° Productores">
   ...
   <table  align="left" width="33%" border="0">  
     <td><fieldset style="border: 3px solid #5eb058;">
     <legend align= "left">Estatus Fisico</legend>
                 KM. Programados <input type="text" name="KM_pro" id="KM_pro" value="<?php echo @$_POST[KM_pro]?>" placeholder="KM Progtramados">
                 <br>
                 KM. Ejecutados<input type="text" name="KM_Eje" id="KM_Eje" value="<?php echo @$_POST[KM_Eje]?>" placeholder="KM Ejecutados">
                 <br>
                 KM. por Ejecutar<input type="text" name="KM_por_Eje" id="KM_por_Eje" value="<?php echo @$_POST[KM_por_Eje]?>" placeholder="KM por Ejecutar">
     </fieldset>
      </td>
      </tr>
    </table>

<table  align="left" width="33%" height="10%" border="0">  
     <td><fieldset style="border: 3px solid #5eb058;">
     <legend align= "left">Estatus Fisico</legend>
                 Avance Fisico(%) <input type="text" name="ava_fisi" id="ava_fisi" value="<?php echo @$_POST[ava_fisi]?>" placeholder="Avance Fisico">
                 </br>
                 Avance Fisico por Ejecutar(%) <input type="text" name="ava_fisi_eje" id="ava_fisi_eje"  value="<?php echo @$_POST[ava_fisi_eje]?>" placeholder="Avance Fisico Ejecutar">
                  </br>
                 Avance Financiero Ejecutado(%)<input type="text" name="ava_fin" id="ava_fin" value="<?php echo @$_POST[ava_fin]?>" placeholder="Avance Finaciero">
...
<table  align="left" width="100%" height="10%" border="0">  
     <td><fieldset style="border: 3px solid #5eb058;">
     <legend align= "left">Estatus Financiero</legend>

    <table  align="left" width="50%" height="10%" border="0">  
     <td><fieldset style="border: 3px solid #5eb058;">
     <legend align= "left">Contrato N°</legend>

     <table  align="left" width="45%" height="10%" border="0">  
     <td><fieldset style="border: 3px solid #5eb058;">
     <legend align= "left">Inversion</legend>

                 Monto Inversion(Bs.)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="monto_inv" id="monto_inv" value="<?php echo @$_POST[monto_inv]?>" placeholder="Monto Inversion">
      <br>     
                 Desembolso(Bs.)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="Desembol" id="Desembol" value="<?php echo @$_POST[Desembol]?>" placeholder="Desembolso">
          <br>                   
                 Por Desembolsar(Bs.)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="por_Desembol" id="por_Desembol" value="<?php echo @$_POST[por_Desembol]?>" placeholder="Por Desembolsar">
     </fieldset>
      </td>
      </tr>
     ...
     <table  align="left" width="45%" height="10%" border="0">  
     <td><fieldset style="border: 3px solid #5eb058;">
     <legend align= "left">Fuente de Financiamiento</legend>

          <textarea name="fuente" id="fuente" cols="30" rows="7"><?php echo @$_POST[fuente]?></textarea>
     </fieldset>
      </td>
      </tr>
    </table>
    ...
    <table  align="left" width="50%" height="10%" border="0">  
     <td><fieldset style="border: 3px solid #5eb058;">
     <legend align= "left">Compromiso de Responsabilidad Social</legend>

     <table  align="left" width="34%" height="10%" border="0">  
     <td><fieldset style="border: 3px solid #5eb058;">
     <legend align= "left">Descripcion</legend>

  <textarea name="descripcion_social" id="descripcion_social" cols="15" rows="7"><?php echo @$_POST[descripcion_social]?></textarea>
     </fieldset>
      </td>
      </tr>
    </table>
     ...
     <table  align="left" width="33%" height="10%" border="0">  
     <td><fieldset style="border: 3px solid #5eb058;">
     <legend align= "left">Estatus</legend>

          <textarea name="estatus_social" id="estatus_social" cols="15" rows="7"><?php echo @$_POST[estatus_social]?></textarea>
     </fieldset>
      </td>
      </tr>
    </table>
     ...
     <table  align="left" width="33%" height="10%" border="0">  
     <td><fieldset style="border: 3px solid #5eb058;">
     <legend align= "left">Monto (Bs.)</legend>

          <textarea name="monto_social" id="monto_social" cols="15" rows="7"><?php echo @$_POST[monto_social]?></textarea>
     </fieldset>
      </td>
      </tr>
    </table>
      ...
      <tr>
       ...
       <?php
        ...
        echo '<input type="submit" name="Add_detalle" id="Add_detalle" value="Agregar Detalles al Proyecto" />';
		?>

...
<form name="frmlogin" method="post" action="acceso.php">
    ...
    <tr>
      <td background="image/loginwindow.jpg">			
		...
		<div style="float:right; width:200px;" align="left">
			<div style="margin:10px 2px 2px 10px;"><input size="14" type="text" name="username" placeholder="USUARIO" /></div>
			<div style="margin:10px 2px 2px 10px;"><input size="14" type="password" name="password" placeholder="CLAVE" /></div>		
